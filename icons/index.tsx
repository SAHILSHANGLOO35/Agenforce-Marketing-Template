...
export const SalesforceIcon = (props: React.SVGAttributes<SVGSVGElement>) => {
  return (
    <svg
      width="15"
      height="10"
...
export const HubspotIcon = (props: React.SVGAttributes<SVGSVGElement>) => {
  return (
    <svg
      width="10"
      height="10"
...
export const GoogleSheetsIcon = (props: React.SVGAttributes<SVGSVGElement>) => {
  return (
    <svg
      width="9"
      height="10"
...
export const SettingsIcon = (props: React.SVGAttributes<SVGSVGElement>) => {
  return (
    <svg
      width="16"
      height="16"
...
export const FacebookMeta = ({ className }: { className?: string }) => {
  return (
    <svg
      id="Layer_1"
      data-name="Layer 1"
...
export const DraftingIcon = ({ className }: { className?: string }) => {
  return (
    <svg
      width="12"
      height="13"
...
export const RecentActivityIcon = ({ className }: { className?: string }) => {
  return (
    <svg
      width="16"
      height="16"
...
export const ArrowReverseIcon = ({ className }: { className?: string }) => {
  return (
    <svg
      width="191"
      height="198"
